...
export default function HomeFeatureChip({ to, title, description, icon }: HomeFeatureChipProps) {
  ...
  return (
    <MotionLink
      ...
      className="tenney-chip tenney-plusgrid group flex h-full flex-col gap-3 rounded-[18px] border border-tenney-line/70 bg-white/70 p-5 text-left shadow-soft backdrop-blur-lg transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tenney-cyan/40 dark:border-tenney-line/60 dark:bg-slate-950/60"
    >
